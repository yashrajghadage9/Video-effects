...
int main(int argc, char** argv) {
    if (argc < 3) {
        std::cerr << "Usage: " << argv[0] << " <input_video> <output_video> [threads]" << std::endl;
        std::cerr << "Example: " << argv[0] << " input.mp4 sketched_output.mp4 8" << std::endl;
        return -1;
    }
    ...
    try {
        std::cout << "=== Video Sketch Effect Build Application ===" << std::endl;
        ...
        std::cout << "Success! Sketched video saved to: " << output_path << std::endl;
